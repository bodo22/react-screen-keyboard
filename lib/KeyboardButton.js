...
var KeyboardButton = function (_PureComponent) {
	...
	function KeyboardButton() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = KeyboardButton.__proto__ || Object.getPrototypeOf(KeyboardButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
			return _this.props.onClick(_this.props.value);
