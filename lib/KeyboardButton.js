...
var KeyboardButton = function (_PureComponent) {
	...
	function KeyboardButton() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = KeyboardButton.__proto__ || Object.getPrototypeOf(KeyboardButton)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			isPressed: false
	...
	_createClass(KeyboardButton, [{
		...
		value: function render() {
			...
			var pressedCls = this.state.isPressed === true ? 'keyboard-button-pressed' : '';
